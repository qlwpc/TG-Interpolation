...
task_list = ["center_embed", "center_embed_mod", "cleft", "cleft_modifier", "fgd_subject", "fgd_object", "fgd_pp", "fgd-embed3", \
    "fgd-embed4", "fgd_hierarchy", "mvrr", "mvrr_mod", "nn-nv-rpl", "npi_orc_any", "npi_orc_ever", "npi_src_any", \
...
task_2_tag = {
    ...
    "cleft_modifier": [{"np_mismatch":[7], "np_match":[7], "vp_mismatch":[6,7], "vp_match":[6,7]}], 
    ...
    "fgd-embed3": [{"what_no-gap":[6], "that_no-gap":[6], "what_gap":[7], "that_gap":[7]}], 
    "fgd-embed4": [{"what_no-gap":[6], "that_no-gap":[6], "what_gap":[7], "that_gap":[7]}],
    ...
    "nn-nv-rpl": [{"nn_ambig":[5], "nn_unambig":[5]}, {"nv_ambig":[5], "nv_unambig":[5]}], 
