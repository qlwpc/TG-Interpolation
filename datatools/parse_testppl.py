...
# benepar 0.2.0 includes protobuf code generated by an older protoc.  Google
# client packages require modern protobuf, so select the compatible pure-Python
# implementation before either benepar or transformers can import protobuf.
