...
from olmo.gpst.utils.model_loader import get_max_epoch_step, load_checkpoint
from olmo.gpst.utils.tree_utils import get_tree_from_merge_trajectory
from olmo.gpst.utils.misc import gpt_token
...
class Trainer(object):
    ...
    def train(self,
        ...
        for step, inputs in enumerate(epoch_iterator):
            ...
            with model.no_sync():
                with torch.amp.autocast('cuda', dtype=amp_dtype, enabled=self.device.type == 'cuda'):
