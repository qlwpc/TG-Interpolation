...
if __name__=="__main__":
    ...
    os.makedirs("bbc_tokenized/tg", exist_ok=True)
    input_directory = "bbc-news/"
    ...
    def tokenize_file(input):
        ...
        np.save("bbc_tokenized/tg/"+input+".npy", TG_data)


    all_files = os.listdir(input_directory)
    all_files = sorted(all_files)
    terminal_dir = "bbc_tokenized/terminal"
    ...
    for filename in all_files:
        ...
        if os.path.isfile(full_path):
            if main_name not in tg_exclude_list:
                ...
                TG_data = vocab.convert_treenpy_to_TG(np.load("bbc_tokenized/tree/" + main_name + ".npy", mmap_mode='r'), vocab)
                np.save("bbc_tokenized/tg/"+main_name+".npy", TG_data)