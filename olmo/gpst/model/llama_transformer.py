...
class Attention(nn.Module):
    ...
    def forward(
        ...
        # NOTE: original used `with torch.backends.cuda.sdp_kernel():` which, with
        # no args, picks default backends. On CUDA PyTorch auto-dispatches to the
        # flash/efficient kernel (the "flash-attn if available" behavior); on CPU
        # the math backend is used. We drop the context manager and let SDPA choose.
